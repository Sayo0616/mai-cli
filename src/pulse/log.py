"""Pulse CLI - History / audit log module.
...
from .config import get_pulse_dir, GLOBAL
...
def write_history(project_root: Path, agent: str, event_type: str,
    ...
    hist_file = get_pulse_dir(project_root) / "history" / f"{today}.log"
...
def read_history(project_root: Path,
    ...
    hist_file = get_pulse_dir(project_root) / "history" / f"{date}.log"
