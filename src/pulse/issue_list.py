"""Pulse CLI - Issue list / show module.
...
from .config import get_queue_sla, get_status_emoji, get_pulse_dir
...
def cmd_issue_list(project_root: Path, queue: Optional[str]):
    from .pulse import out, out_json, ensure_pulse_structure, GLOBAL
...
def cmd_issue_show(project_root: Path, issue_id: str):
    from .pulse import out, out_json, err, GLOBAL
